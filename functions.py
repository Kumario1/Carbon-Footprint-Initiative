...
def chart(model, scaler,sample_df, prediction):
    ...
    patches, texts = plt.pie(x=p.values(),
                             ...
                             explode=[0.03] * 4,
                             labeldistance=0.75,
                             colors=["#016c40", "#017a45", "#028c50", "#009d57" ], shadow=True,
